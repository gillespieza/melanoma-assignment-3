...
> - **Primary Scripts**:
>   - [`run_univariate_associations.py`](../../scripts/pillar_2_clinical_subtyping/run_univariate_associations.py): Computes univariate ORs and 95% CIs across clinical/genomic features; generates forest plots.
> - **Shared Modules**:
