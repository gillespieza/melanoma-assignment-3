...
def _report_section_1a(
    ...
    return (
        ...
        "> - **Questions**: Does cohort-independent Z-score standardisation eliminate "
...
def _report_section_2(
    ...
    return (
        ...
        "> - **Questions**: Can therapeutic response be predicted directly from global "
...
def _report_section_3(n_trials: int) -> str:
    ...
    return (
        ...
        "> - **Questions**: Are cohort expression baselines visibly harmonised after "
...
def _script_entries_p1() -> List[Tuple[str, Path, str]]:
    ...
    p1_dir = SUBPROJECT_ROOT / "scripts" / "pillar_1_cohort_preprocessing"
    return [
        (
...
_COMPANION_SCRIPTS: List[Tuple[str, Path]] = [
    (
        ...
        SUBPROJECT_ROOT / "scripts" / "pillar_1_cohort_preprocessing" / _HEATMAP_SCRIPT_NAME,
    ),
]
