...
_SCRIPT_REFERENCE_SPECS: list[tuple[str, Path, str]] = [
    (
        ...
        _SUBPROJECT_ROOT / "scripts" / "pillar-1-cohort-preprocessing" / "run_clinical_analysis.py",
    ...
    (
        "clean_data.py",
        _SUBPROJECT_ROOT / "scripts" / "pillar-1-cohort-preprocessing" / "clean_data.py",
        "Preprocesses raw cohort clinical metadata and RNA-seq expression profiles into "
        "cleaned CSV matrices.",
    ),
    (
        "merge_datasets.py",
        _SUBPROJECT_ROOT / "scripts" / "pillar-1-cohort-preprocessing" / "merge_datasets.py",
...
def _build_report_section1(
    ...
    callout = (
        ...
        f"> - **Question Answered**: Are patient populations comparable across cohorts?\n\n"
...
def _build_report_section2(
    ...
    return (
        ...
        f"> - **Question Answered**: How many patients are retained for downstream analysis?\n\n"
...
def _build_report_section3_4(
    ...
    return (
        ...
        f"> - **Question Answered**: How does overall survival compare across independent immunotherapy trial cohorts?\n\n"
        ...
        f"> - **Question Answered**: Does RECIST response reliably distinguish durable long-term benefit?\n\n"
