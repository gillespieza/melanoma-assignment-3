...
def main():
    ...
    # Calculate confidence intervals via bootstrap or asymptotic Wald standard errors
    # For simplicity and speed, we use the asymptotic Fisher Information Matrix to get standard errors
    ...
    # X-axis log scale is standard for odds ratios
    plt.xscale('log')
    # Set reasonable ticks for log scale
