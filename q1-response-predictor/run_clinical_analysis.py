"""
Master script for clinical analysis and exploration.

Phase 1: Kaplan-Meier Overall Survival curves for all four melanoma cohorts,
         rendered as a single 2x2 grid figure.
"""
import sys
import pandas as pd
import numpy as np
