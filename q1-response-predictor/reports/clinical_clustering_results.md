...
We performed unsupervised phenotyping on the **TCGA-SKCM** cohort ($N = 426$ patients) using Agglomerative Hierarchical Clustering (Ward linkage). Patient profiles were constructed across demographics, tumour genetics, microenvironmental stress, and adjuvant therapy classes.
...
2.  **Cluster 1: High Mutational Load & Immunotherapy Phenotype** ($N=112$)
    ...
    *   *Clinical*: Stage IV rate = 0.0%. Lower primary tumour rate (14.3%). High rate of immunotherapy (63.4%).
