...
cssclasses:
  ...
  - table-center
  - row-alt
created: 2026-08-02 14:02
updated: 2026-08-02 14:02
---
...
> 3. **Tier 2 Pathological Staging Independence**: **`Primary Tumour (t) Staging: T4B`** is the strongest univariate predictor in TCGA ($\text{HR} = 3.19$, $p = 3.17 \times 10^{-11}$, FDR $= 2.44 \times 10^{-9}$), and retains significant independent risk elevation in multivariate Cox regression (Model C-index = **0.712**).
...
> - **High-Dimensional Dummy Encoding**: One-hot encoding of 80 categorical staging variables creates sparse, high-dimensional feature matrices. Multivariate models in Tier 2 are particularly susceptible to overfitting and convergence instability at low per-category sample counts.
