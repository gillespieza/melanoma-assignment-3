...
def main():
    ...
    # Ensure only Primary and Metastasis values are plotted
    ...
    # We want to compare Chemotherapy vs Immunotherapy vs Targeted Therapy vs None
