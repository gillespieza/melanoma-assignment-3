...
def main():
    ...
    # Response mapping
    response_colors_map = {1.0: '#d62728', 0.0: '#9467bd'} # Red for Responder, Purple for Non-Responder
    col_response_colors = y_all.map(response_colors_map)
    
    # Combine metadata column colors
    ...
    g = sns.clustermap(
        sig_corrected.T,
        cmap="RdBu_r",
        z_score=0, # Z-score standardise across patients (rows/signatures here)
        metric="euclidean",
        method="ward",
        col_colors=col_colors,
        figsize=(12, 8),
        cbar_kws={'label': 'Z-score expression'},
        xticklabels=False # Hide individual patient IDs for clean visual
    )
    ...
    dest_path = Path("C:/Users/Amanda/.gemini/antigravity/brain/4bb83474-71a7-4da3-beda-f3ee3b7eba05/signature_clustermap.png")
    import shutil
    ...
    # Perform Agglomerative Clustering to define 2 distinct patient groups
