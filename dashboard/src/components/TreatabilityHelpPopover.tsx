      ...
      {isOpen &&
        createPortal(
          <div
            ...
            className="w-80 sm:w-96 rounded-xl border border-clinical-border bg-white p-4 shadow-2xl text-left text-clinical-ink normal-case font-normal animate-in fade-in zoom-in-95 duration-150"
          >
