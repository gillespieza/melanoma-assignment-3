...
export function ConfidenceHelpPopover({ size = 11 }: { size?: number }) {
  ...
  return (
    <div className="relative inline-flex items-center normal-case font-normal">
      <button
        ref={buttonRef}
        type="button"
        onClick={(e) => {
      ...
      {isOpen &&
        createPortal(
          <div
            ...
            className="w-72 sm:w-80 rounded-xl border border-clinical-border bg-white p-3.5 shadow-2xl text-left text-clinical-ink normal-case font-normal animate-in fade-in zoom-in-95 duration-150"
          >
