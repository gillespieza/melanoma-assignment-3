...
# Full descriptive suffixes appended to each short phenotype label for CSV and plot legends.
# The short-name key is produced data-driven by assign_phenotype_labels(); only the
# human-readable descriptor suffix is fixed here — it describes the biology, not the cluster ID.
...
def main() -> None:
    ...
    # Build full descriptive label map for the CSV and projection plots
    ...
    # 5. Generate 300 DPI 2D Cluster Projection Figures (both PCA and UMAP)
