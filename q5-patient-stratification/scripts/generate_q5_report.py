...
def main() -> None:
    ...
    if PHASE6_PHENO_PLOT_PATH.exists():
        ...
        doc_sections.append(
            ...
            f"> - **Key Takeaways**:\n"
            f">   - **Phenotype-Tailored Value**: The Q5 Phenotype-Stratified model delivers positive Net Benefit across all four subgroups, maintaining high clinical gain in *Immune Hot* and *Mutant-Driven* tumours while effectively filtering non-responders in *Immune Cold* tumours.\n"
            f">   - **Sparing Immunosuppressive & Cold Tumours**: In hard-to-treat *Immune Cold* and *M2 Immunosuppressive* phenotypes, unselected 'Treat All' yields poor net benefit due to high false-positive rates; Q5 stratification avoids futile monotherapy in these patients.\n"
            f">   - **Rationale for Stratified Decision Support**: Confirms that biological heterogeneity requires subgroup-tailored decision thresholds rather than a one-size-fits-all clinical policy.\n"
        )
