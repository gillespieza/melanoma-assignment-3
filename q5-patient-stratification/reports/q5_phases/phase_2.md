...
- **Continuous Association**: Mann-Whitney U tests confirm that `TIS`, `CYT`, and `CD8_T_cells` scores are significantly higher in Responders ($CR/PR$) compared to Non-Responders ($PD$).
...
### Key Takeaways & Analytical Summary
...
> [!NOTE] Phase 2 Executive Summary
...
>   - [`02_feature_analysis.py`](file:///c:/Users/Amanda/Dropbox/OBSIDIAN/42/090%20STUDY/091%20UCD/091.03%20ASSIGNMENTS/AI-ML-3/melanoma-assignment-3/q5-patient-stratification/scripts/02_feature_analysis.py): Performs univariate continuous association testing (Mann-Whitney U, Cohen's d), calculates Youden optimal decision cutoffs, fits logistic regression genomic interaction models (`TIS` x `BRAF`), and exports publication-quality 300 DPI plots and summary CSVs.
> - **Core Supporting & Central Modules**:
>   - [`biology_constants.py`](file:///c:/Users/Amanda/Dropbox/OBSIDIAN/42/090%20STUDY/091%20UCD/091.03%20ASSIGNMENTS/AI-ML-3/melanoma-assignment-3/src/biology_constants.py): Central source of truth defining immune feature panels (`KEY_IMMUNE_FEATURES`), driver mutations (`KEY_DRIVER_MUTATIONS`), and clinical column exclusions (`CLINICAL_EXCLUDE_COLUMNS`).
>   - [`styles.py`](file:///c:/Users/Amanda/Dropbox/OBSIDIAN/42/090%20STUDY/091%20UCD/091.03%20ASSIGNMENTS/AI-ML-3/melanoma-assignment-3/src/styles.py): Central visual style definitions, Okabe-Ito colour palettes (`RESPONSE_PALETTE`, `PHENOTYPE_PALETTE`), and diverging colormaps (`get_okabe_ito_diverging_cmap`).
> - **Shared Cross-Question & Pipeline Modules**:
>   - [`phase2_preprocess_data.py`](file:///c:/Users/Amanda/Dropbox/OBSIDIAN/42/090%20STUDY/091%20UCD/091.03%20ASSIGNMENTS/AI-ML-3/melanoma-assignment-3/q3-ode-model/scripts/phase2_preprocess_data.py): Q3 ODE pre-processing script extracting survival, 12 pathway genes, and BRAF/NRAS mutation status for TCGA-SKCM cohort integration.
...
>   - [`generate_q5_report.py`](file:///c:/Users/Amanda/Dropbox/OBSIDIAN/42/090%20STUDY/091%20UCD/091.03%20ASSIGNMENTS/AI-ML-3/melanoma-assignment-3/q5-patient-stratification/scripts/generate_q5_report.py): Reads association CSVs and updates phase markdown reports.
