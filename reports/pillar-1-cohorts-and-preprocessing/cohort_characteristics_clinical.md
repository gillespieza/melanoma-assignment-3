...
> **What**: We compare patient demographics, treatment histories, and survival outcomes across the three active immunotherapy trial cohorts.
...
- **Panel B: Age Distribution across Studies**: Patient ages span from 19 to 89 years with a **median age of 57.0 years** ($	ext{IQR} = 50.0	ext{--}64.0	ext{ years}$). Trial cohorts (`Liu 2019`: median NR; `Hugo 2016`: median 61.0; `Riaz 2017`: median 56.0) display consistent age distributions centred around late middle age.
